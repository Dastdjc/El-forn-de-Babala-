...
public class eventSystem : MonoBehaviour
{
    ...
    {
        // Calcular recompensa
        int multiplicador = puntuacion / 110;
        harina = (int)(multiplicador * 10 * Random.Range(0.8f, 1f));
        levadura = (int)(multiplicador * 5 * Random.Range(0.8f, 1f));
        aceite = (int)(multiplicador * 6 * Random.Range(0.8f, 1f));
        mantequilla = (int)(multiplicador * 5 * Random.Range(0.8f, 1f));
        azucar = (int)(multiplicador * 8 * Random.Range(0.8f, 1f));
